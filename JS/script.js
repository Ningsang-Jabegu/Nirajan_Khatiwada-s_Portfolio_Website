...
const pages_name = [
  "index", "posts", "songs", "projects", "contact_us" // This is pages id
]
const page_display_name = [
  "Home", "Posts", "Songs", "Projects", "Contact us" // This is pages display name in nav bar
]
...
for (let i = 0; i < pages_name.length; i++) {
  if (pages_name[i] == body_id) {
      ...
      body_ul_nav.querySelectorAll("li")[pages_name.length - 1].classList.add("dropdown");
  }
}
}